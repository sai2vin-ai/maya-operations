                ...
                <div className="glass-card p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-4xl font-bold text-foreground">
                                {item.currentStock} <span className="text-lg text-foreground-muted">{item.unit}</span>
                            </p>
                            <span
                                className={`inline-block mt-2 px-3 py-1 text-sm font-medium rounded-full ${stockStatus.bg}`}
                            >
                                {stockStatus.label}
                            </span>
                        </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-border">
                        ...
                        <div>
                            ...
                            <p className="text-foreground font-medium">
                                {item.maximumStock ? `${item.maximumStock} ${item.unit}` : '-'}
                            </p>
                        </div>
                        {item.location && (
                ...
                <div className="glass-card p-6">
                    ...
                    {transactions.length === 0 ? (
                        <div className="text-center py-8">
                            <svg
                                className="w-12 h-12 text-foreground-faint mx-auto mb-3"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                            >
                        ...
                        <div className="space-y-3">
                            {transactions.map((txn) => {
                                ...
                                const isPositive =
                                    ...
                                    (txn.transactionType === 'ADJUSTMENT' && txn.quantity > 0);
                                return (
                                    <div
                                        key={txn.id}
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                {txn.reason && (
                                                    <p className="text-xs text-foreground-faint mt-1">{txn.reason}</p>
                                                )}
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            ...
                                            >
                                                {isPositive ? '+' : '-'}
                                                {Math.abs(txn.quantity)} {item.unit}
                                            </p>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={editMaxStock}
                                        onChange={(e) =>
                                            setEditMaxStock(e.target.value ? parseFloat(e.target.value) : '')
                                        }
                                        min="0"
                                        step="0.01"
                                        className="input-field w-full"
