            ...
            <div className="flex items-center gap-2">
                ...
                >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M12 12h.01M12 9v.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"
                        />
                    </svg>
                </button>
                ...
                <div className="hidden sm:flex items-center gap-2">
                    <div className="text-right">
                        ...
                        <p className="text-xs text-foreground-muted uppercase tracking-wider leading-tight">
