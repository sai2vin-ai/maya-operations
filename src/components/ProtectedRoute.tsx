        ...
        return (
            <div className="min-h-screen bg-slate-900 flex items-center justify-center">
                <div className="glass-card p-8 text-center max-w-md">
                    ...
                    <p className="text-slate-400 mb-4">Your account is not fully configured. Please contact an administrator.</p>
                    <button
        ...
        return (
            <div className="min-h-screen bg-slate-900 flex items-center justify-center">
                <div className="glass-card p-8 text-center max-w-md">
                    ...
                    <p className="text-slate-400 mb-4">Your account has been suspended. Please contact an administrator.</p>
                </div>
            </div>
        );
    }
