...
import { ROLE_DEFINITIONS, MODULES, ROLE_COLORS, type ModuleKey } from '../../config/roles';
    ...
    return (
        <div>
            ...
            <div className="flex gap-2 mb-4">
                ...
                <span className="ml-auto text-sm text-foreground-faint self-center">
                    {ROLE_DEFINITIONS.length} roles defined
                </span>
            </div>
                ...
                <div className="glass-card overflow-x-auto">
                                            ...
                                            <td key={role.value} className="p-4 text-center">
                                                {perms.length > 0 ? (
                                                    <div className="flex flex-wrap justify-center gap-1">
                                                        {perms.includes('view') && (
                                                            <span
                                                                className="w-6 h-6 rounded bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs"
                                                                title="View"
                                                            >
                                                                V
                                                            </span>
                                                        ...
                                                        {perms.includes('create') && (
                                                            <span
                                                                className="w-6 h-6 rounded bg-green-500/20 text-green-400 flex items-center justify-center text-xs"
                                                                title="Create"
                                                            >
                                                                C
                                                            </span>
                                                        ...
                                                        {perms.includes('edit') && (
                                                            <span
                                                                className="w-6 h-6 rounded bg-yellow-500/20 text-yellow-400 flex items-center justify-center text-xs"
                                                                title="Edit"
                                                            >
                                                                E
                                                            </span>
                                                        ...
                                                        {perms.includes('delete') && (
                                                            <span
                                                                className="w-6 h-6 rounded bg-red-500/20 text-red-400 flex items-center justify-center text-xs"
                                                                title="Delete"
                                                            >
                                                                D
                                                            </span>
                    ...
                    <div className="p-4 border-t border-border">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="w-6 h-6 rounded bg-green-500/20 text-green-400 flex items-center justify-center text-xs">
                                    C
                                </span>
                                <span className="text-foreground-muted text-sm">Create</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-6 h-6 rounded bg-yellow-500/20 text-yellow-400 flex items-center justify-center text-xs">
                                    E
                                </span>
                                <span className="text-foreground-muted text-sm">Edit</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-6 h-6 rounded bg-red-500/20 text-red-400 flex items-center justify-center text-xs">
                                    D
                                </span>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-foreground-muted text-sm">
                            Roles determine what features and data users can access in the system. Each role has
                            specific permissions for different modules. To change a user's access level, update their
                            role in the User Management section.
                        </p>
                    </div>
                </div>
            </div>
