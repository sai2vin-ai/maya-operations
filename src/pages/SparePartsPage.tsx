...
// Displays all spare parts with search, filter, and stock status indicators

import { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { getSpareParts, SPARE_PART_CATEGORIES } from '../services/sparePartsService';
...
export function SparePartsPage() {
    ...
    const loadParts = async () => {
        try {
            setLoading(true);
            setError(null);
            const fetchedParts = await getSpareParts(100);
    ...
    const filteredParts = parts.filter(part => {
        const matchesSearch = searchQuery === '' ||
            ...
            (part.fileNumber && part.fileNumber.toLowerCase().includes(searchQuery.toLowerCase()));
        ...
        return (
            <div className="p-6 flex items-center justify-center min-h-screen">
                <div className="text-center">
                    ...
                    <p className="text-slate-400">Loading spare parts...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="p-6 max-w-6xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-slate-400">{parts.length} parts • {lowStockCount} low stock</p>
                </div>
                <button
